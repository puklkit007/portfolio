...
var Particles2 = class extends import_react.Component {
  constructor(props) {
    super(props);
    this.state = {
      init: false,
  ...
  async loadParticles() {
    ...
    const id = (_b = (_a = this.props.id) !== null && _a !== void 0 ? _a : Particles2.defaultProps.id) !== null && _b !== void 0 ? _b : defaultId, container = this.props.url ? await tsParticles.loadJSON(id, this.props.url) : await tsParticles.load(id, (_c = this.props.params) !== null && _c !== void 0 ? _c : this.props.options);
    await cb(container);
  }
};
...
var esm_default = Particles2;
export {
  Particles2 as Particles,
